...
public class ShoesFrag extends Fragment implements colorIDs {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.shoesHolderRec);
        recyclerView.setHasFixedSize(true);
        recyclerView.setNestedScrollingEnabled(false);
        new CardSnapHelper().attachToRecyclerView(recyclerView);

        newitemRec = view.findViewById(R.id.newItemShoesHolderRec);
        ...
        linearUp=view.findViewById(R.id.shoesDown);
        linearDown=view.findViewById(R.id.shoesup);
