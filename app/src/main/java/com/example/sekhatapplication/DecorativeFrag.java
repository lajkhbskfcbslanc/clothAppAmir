...
public class DecorativeFrag extends Fragment implements colorIDs {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //1
        View view = inflater.inflate(R.layout.fragment_decorative, container, false);

        recyclerView = view.findViewById(R.id.decorativeHolderRec);
        recyclerView.setHasFixedSize(true);
        recyclerView.setNestedScrollingEnabled(false);
        new CardSnapHelper().attachToRecyclerView(recyclerView);

        newitemRec = view.findViewById(R.id.newItemDecorativeHolderRec);
        ...
        linearUp=view.findViewById(R.id.decorativeDown);
        linearDown=view.findViewById(R.id.decorativeup);
