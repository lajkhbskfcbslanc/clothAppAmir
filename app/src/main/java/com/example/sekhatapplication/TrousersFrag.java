...
public class TrousersFrag extends Fragment implements colorIDs {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.trouserHolderRec);
        recyclerView.setHasFixedSize(true);
        recyclerView.setNestedScrollingEnabled(false);
        new CardSnapHelper().attachToRecyclerView(recyclerView);

        newitemRec = view.findViewById(R.id.newItemTrouserHolderRec);
        ...
        linearUp=view.findViewById(R.id.trouserDown);
        linearDown=view.findViewById(R.id.trouserup);
